          ...
          if (meRegex.test(msgTxt)) {
            ...
            try {
              const templateMessage = {
                image: {
                  url: join(__dirname, "../groupPict.jpg"),
                },
                caption: `*BOT WHATSAPP BY _${pushName}_*
▭▬▭▬▭(  *INFO CREATOR* )▭▬▭▬▭

*┌◦ Nama BOTz :* *${pushName}*
*│◦ Version BOTz :* *v.1.03*
*│◦ Nomor Creator :* *http://wa.me//6285926340758*
*│◦ YouTube :* *https://youtube.com/@HanszzzMods*
*│◦ Status :* *Owner Bot*
*│◦ Base Ori :* *HanszzzBotz*
*└◦ Jenis Script :* *Hanszzz Official*
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭

▭▬▭▬▭(  *MENU PUSH* )▭▬▭▬▭

┏━ ◦ .pushContact *text|delay*
┣❏ ◦ .saveContact *Database*
┣❏ ◦ .exportContact *save*
┣❏ ◦ .saveUser
┣❏ ◦ .clone *namagc*
┣❏ ◦ .dropUser
...
*NOTE : CARA² PUSH KONTAK*
1. .pushContact *teks|delay*
2. .saveContact *Ke database dlu*
3. .exportContact *tinggal save*
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭

*GRUP INFO PANEL*
*https://chat.whatsapp.com/BkNBN3oZovh7vSzc54ZF9J*
...
*_© HANSZZZ STORE`,
                headerType: 4,
                mentions: ["6285926340758@s.whatsapp.net"],
              };
          ...
          if (regexInfo.test(msgTxt)) {
            ...
            logging("info", `Get Message`, msgTxt);
            try {
              const templateText = `*HanszzzBotzz* | Group info\n\n*Group Name :* ${
            ...
            if (!messagePushCont) {
              try {
                await reybot.sendMessage(
                  groupId,
                  {
                    text: `*HanszzzBotzz* | Push contact
...
*Delay |> :* ${delayPushCont} detik
*YT : youtube.com/@yttozzstore1019*`,
                    mentions: ["6285926340758@s.whatsapp.net"],
                  },
                  { quoted: msg }
                );
                ...
                if (groupParticipants.length === sent) {
                  try {
                    await reybot.sendMessage(
                      groupId,
                      {
                        text: `*HanszzzBotz* | Push contact
*Push Contact Selesa Masbro ⚡i*
          ...
          if (saveContactsRegex.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: `*HanszzzBotz* | Save Contacts
*Save Contacts Start*
*Total Member Group :* ${groupParticipants.length}
*YT : youtube.com/@HanszzzMods*`,
                  mentions: ["6285926340758@s.whatsapp.net"],
                },
                { quoted: msg }
              );
            ...
            if (contacts.length === 0) {
              try {
                await reybot.sendMessage(
                  groupId,
                  {
                    text: `*HanszzzBotz* | Export Contact
*Database Contact Masih Kosong Bro*
*Simpan Beberapa Nomor Terlebih Dahulu Jika Ingin Menggunakan Fitur Ini:v*`,
                    mentions: ["6285926340758@s.whatsapp.net"],
                  },
                  { quoted: msg }
                );
          ...
          if (dropUser.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: "*HanszzzBotz* | Drop Database Users\n\n*Baik _Tunggu Sebentarr_*",
                  mentions: ["6285926340758@s.whatsapp.net"],
                },
                { quoted: msg }
              );
          ...
          if (dropContact.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                groupId,
                {
                  text: "*HanszzzBotz* | Drop Database Contacts\n\n*Baik _Tunggu Sebentart_*",
                  mentions: ["6285926340758@s.whatsapp.net"],
                },
                { quoted: msg }
              );
              ...
              try {
                ...
                await reybot.sendMessage(
                  groupId,
                  {
                    text: `*HanszzzBotz* | Push contact
*Push Contact Start*
*Target |> :* ${groupParticipants.length}
*Pesan |> :* ${messagePushCont}
*Delay |> :* ${delayPushCont} Detik
*YT :* youtube.com/@yttozzstore1019`,
                    mentions: ["6285926340758@s.whatsapp.net"],
...
*│◦ Version BOTz :* *v.1.03*
*│◦ Nomor Creator :* *http://wa.me//6285926340758*
*│◦ YouTube :* *youtube.com/@HanszzzMods*
*│◦ Status :* *Owner Bot*
*│◦ Base Ori :* *TozzBotz*
*└◦ Jenis Script :* *TOZZ STORE*
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
...
*GRUP INFO PANNEL*
*https://chat.whatsapp.com/GUVYpeOGWYEIc5Rd2q9fmI*
            ...
            if (!messagePushCont) {
              try {
                await reybot.sendMessage(
                  ...
                  {
                    text: `*HanszzzBotz* | Push contact
*Format Yang Lu Gunakan Salah Masbro ⚡*
*Error :* Format Tidak Valid
*_Contoh_:* .pushCont Pesan Push Contact|3000`,
                  },
                  { quoted: msg }
...
*_Contoh_:* .pushCont ${messagePushCont}|3000`,
          ...
          if (contactRegex.test(msgTxt)) {
            ...
            try {
              ...
              await reybot.sendMessage(userId, {
                text: `*HanszzzBotz* | Save
*DONE Nomorlu Udah Gua Save*
*Save Back _${pushName}_ Ga Save Unsv*`,
              });
            } catch (err) {
            ...
            if (contacts.length === 0) {
              try {
                await reybot.sendMessage(
                  userId,
                  {
                    text: `*TozzBotz* | Export Contact
*Database Contact Dlu La:v*
          ...
          if (dropContact.test(msgTxt)) {
            ...
            try {
              await reybot.sendMessage(
                userId,
                {
                  text: "*TozzBotz* | Drop Database Contacts\n\n*Baik _Tunggu Sebentart_*",
                },
                { quoted: msg }
              );
              contacts.splice(0, contacts.length);
...
*_Contoh_:* .pushCont Pesan Push Contact|3000`,
              ...
              try {
                await reybot.sendMessage(
                  userId,
                  {
                    text: `*HanzzzBotz* | Push contact
*Format Yang Lu Gunakan Salah Masbro*
*Error :* Dibelakang pesan tambahkan delay, Jeda berapa detik setiap mengirim pesan & harus berformat angka
